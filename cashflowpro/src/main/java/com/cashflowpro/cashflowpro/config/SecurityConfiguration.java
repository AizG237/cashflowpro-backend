...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers("/auth/**","/facture/**")
                .hasAnyRole("DIRECTEUR")
                .requestMatchers("/auth/register/employe")
                .hasAnyRole("DIRECTEUR")
                .requestMatchers("/facture/**")
                .hasAnyRole("RESPONSABLE")
                .requestMatchers("/Broker/**")
                .hasAnyRole("DIRECTEUR","RESPONSABLE")
                .requestMatchers("/wallet//get/{id}")
                .permitAll()
                 .anyRequest()
                .authenticated()
                .and()
